...
#     data, label = gen_union_of_subspaces(ambient_dim, subspace_dim, num_subspaces, num_points_per_subspace, 0.0)
#
#     # =================================================
...
#
# plt.plot(subspace_dims, algorithm_time, linewidth=2)
# plt.title('SSC-OMP - Time', fontsize=20)
# plt.xlabel("Dimension", fontsize=14)
# plt.ylabel("Time", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/dimension/SSC-OMP1.png')
# plt.show()
#
# plt.plot(subspace_dims, algorithm_nmi, linewidth=2)
# plt.title('SSC-OMP - NMI', fontsize=20)
# plt.xlabel("Dimension", fontsize=14)
# plt.ylabel("Normalized Mutual Information", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/dimension/SSC-OMP2.png')
# plt.show()
#
# plt.plot(subspace_dims, algorithm_ari, linewidth=2)
# plt.title('SSC-OMP - ARI', fontsize=20)
# plt.xlabel("Dimension", fontsize=14)
# plt.ylabel("Adjusted Random Index", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/dimension/SSC-OMP3.png')
# plt.show()
...
# plt.title('LRR - Time', fontsize=20)
# plt.xlabel("Angle", fontsize=14)
# plt.ylabel("Time", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/angle/LRR1.png')
# plt.show()
#
# plt.plot(angles, algorithm_nmi, linewidth=2)
# plt.title('LRR - NMI', fontsize=20)
# plt.xlabel("Angle", fontsize=14)
# plt.ylabel("Normalized Mutual Information", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/angle/LRR2.png')
# plt.show()
#
# plt.plot(angles, algorithm_ari, linewidth=2)
# plt.title('LRR - ARI', fontsize=20)
# plt.xlabel("Angle", fontsize=14)
# plt.ylabel("Adjusted Random Index", fontsize=14)
# plt.tick_params(axis='both', labelsize=10)
# plt.savefig('image/angle/LRR3.png')
# plt.show()
...
for noise in noises:
    data, label = gen_union_of_subspaces(ambient_dim, subspace_dim, num_subspaces, num_points_per_subspace, noise)
...
plt.plot(noises, algorithm_time, linewidth=2)
plt.title('LRR - Time', fontsize=20)
plt.xlabel("Dimension", fontsize=14)
plt.ylabel("Time", fontsize=14)
plt.tick_params(axis='both', labelsize=10)
plt.savefig('image/Noise/LRR1.png')
plt.show()

plt.plot(noises, algorithm_nmi, linewidth=2)
plt.title('LRR - NMI', fontsize=20)
plt.xlabel("Dimension", fontsize=14)
plt.ylabel("Normalized Mutual Information", fontsize=14)
plt.tick_params(axis='both', labelsize=10)
plt.savefig('image/Noise/LRR2.png')
plt.show()

plt.plot(noises, algorithm_ari, linewidth=2)
plt.title('LRR - ARI', fontsize=20)
plt.xlabel("Noise", fontsize=14)
plt.ylabel("Adjusted Random Index", fontsize=14)
plt.tick_params(axis='both', labelsize=10)
plt.savefig('image/Noise/LRR3.png')
plt.show()
